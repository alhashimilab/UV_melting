...
def fit_data(filename, temperature, absorbance):
    ...
    if mode == 'hairpin': 
        print "Hairpin"
        #def uv_hairpin_es(t, mss, bss, mds, bds, mds2, bds2, delHconf, delSconf, delHm, delSm):
        p0 = np.array([0.00008, 1.029, 0.00007, 0.867, 0.00007, 0.867, -3.554, -0.014446, 71.66, 0.204])
        #p0 = np.array([0.00008, 1.029, 0.00007, 0.867, 0.00007, 0.867, -27.13, -0.092652, 71.66, 0.204])
        #p0 = np.array([0.00008, 1.029, 0.00007, 0.867, 0.00007, 0.867, -2.479, -0.010384, 71.66, 0.204])
        #p0 = np.array([0.00008, 1.029, 0.00007, 0.867, 0.00007, 0.867, 3.5, 0.03777, 71.66, 0.204])
