...
def fit_data(filename, temperature, absorbance):
    ...
    if mode == 'hairpin': 
        print "Hairpin"
        #def uv_hairpin_es(t, mss, bss, mds, bds, mds2, bds2, delHconf, delHm, delSm):
        #p0 = np.array([0.000580, 0.956, 0.000313, 0.856, 0.000313, 0.856, -27.13, 62.96, 0.186])
        #p0 = np.array([0.000580, 0.956, 0.000313, 0.856, 0.000313, 0.856, -3.5, 62.96, 0.186])
        #p0 = np.array([0.000580, 0.956, 0.000313, 0.856, 0.000313, 0.856, -2.5, 62.96, 0.186])
        #p0 = np.array([0.000580, 0.956, 0.000313, 0.856, 0.000313, 0.856, 3.5, 62.96, 0.186])
        p0 = np.array([0.000580, 0.956, 0.000313, 0.856, 0.000313, 0.856, 0.0, 62.96, 0.186])
