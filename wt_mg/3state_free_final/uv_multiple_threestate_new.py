...
def fit_data(filename, temperature, absorbance):
    ...
    if mode == 'hairpin': 
        print "Hairpin"
        #def uv_hairpin_es(t, mss, bss, mds, bds, mds2, bds2, delHconf, delSconf, delHm, delSm):
        p0 = np.array([0.000389, 0.986, 0.000391, 0.870, 0.000391, 0.870, -3.554, -0.014446, 74.24, 0.2115])
        #p0 = np.array([0.000389, 0.986, 0.000391, 0.870, 0.000391, 0.870, -27.13, -0.092, 74.24, 0.2115])
        #p0 = np.array([0.000389, 0.986, 0.000391, 0.870, 0.000391, 0.870, -2.479, -0.010384, 74.24, 0.2115])
        #p0 = np.array([0.000389, 0.986, 0.000391, 0.870, 0.000391, 0.870, 0.0, -0.003777, 74.24, 0.2115])
        #p0 = np.array([0.000389, 0.986, 0.000391, 0.870, 0.000391, 0.870, 3.5, 0.003777, 74.24, 0.2115])
