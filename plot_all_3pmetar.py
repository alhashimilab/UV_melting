...
plot_uv(axarr[0, :], '3pme/2state_final/', '2state.csv', 'TAR-C24U25A35 -Mg' + '$^{2+}$' + '\n2-state\nA' + '$_{260}$', [0.84, 1.03], np.arange(0.85, 1.01, 0.05), [10.0, 100.0], np.arange(20.0, 101.0, 20), 0, '2state')
plot_uv(axarr[1, :], '3pme/3state_constrain/', '3state_constrain.csv', 'TAR-C24U25A35 -Mg' + '$^{2+}$' + '\n3-state fix p' + '$_{B}$' + '\nA' + '$_{260}$', [0.84, 1.03], np.arange(0.85, 1.01, 0.05), [10.0, 100.0], np.arange(20.0, 101.0, 20), 0, '3state_constrain')
plot_uv(axarr[2, :], '3pme/3state_free_final/', '3state_free_final.csv', 'TAR-C24U25A35 -Mg' + '$^{2+}$' + '\n3-state free\nA' + '$_{260}$', [0.84, 1.03], np.arange(0.85, 1.01, 0.05), [10.0, 100.0], np.arange(20.0, 101.0, 20), 1, '3state_free')

for dummy in range(3):
    axarr[2, dummy].set_xlabel('Temperature (' + '$^\circ$' + 'C)', fontsize=fs)
#plt.show()
plt.savefig('3pme.pdf')
