...
def fit_data(filename, temperature, absorbance):
    ...
    if mode == 'hairpin': 
        print "Hairpin"
        #def uv_hairpin_es(t, mss, bss, mds, bds, mds2, bds2, delHconf, delSconf, delHm, delSm):
        p0 = np.array([0.000580, 0.956, 0.000313, 0.856, 0.000313, 0.856, -27.1, -0.092652, 62.96, 0.186])
        #p0 = np.array([0.000580, 0.956, 0.000313, 0.856, 0.000313, 0.856, -3.554, -0.014446, 62.96, 0.186])
        #p0 = np.array([0.000580, 0.956, 0.000313, 0.856, 0.000313, 0.856, -2.749, -0.010384, 62.96, 0.186])
        #p0 = np.array([0.000580, 0.956, 0.000313, 0.856, 0.000313, 0.856, 0.0, -0.003777, 62.96, 0.186])
        #p0 = np.array([0.000580, 0.956, 0.000313, 0.856, 0.000313, 0.856, -27.1, 0.092652, 62.96, 0.186])
        #p0 = np.array([0.000580, 0.956, 0.000313, 0.856, 0.000313, 0.856, -2.749, 0.010384, 62.96, 0.186])
        #p0 = np.array([0.000580, 0.956, 0.000313, 0.856, 0.000313, 0.856, 0.0, 0.003777, 62.96, 0.186])
