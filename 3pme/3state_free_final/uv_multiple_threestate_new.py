...
def fit_data(filename, temperature, absorbance):
    ...
    if mode == 'hairpin': 
        print "Hairpin"
        p0 = np.array([0.000732, 0.942, 0.000564, 0.838, 0.000564, 0.838, -27.13, -0.092652, 64.99, 0.1919])
        #p0 = np.array([0.000732, 0.942, 0.000564, 0.838, 0.000564, 0.838, -3.554, -0.014446, 64.99, 0.1919])
        #p0 = np.array([0.000732, 0.942, 0.000564, 0.838, 0.000564, 0.838, 0.0, -0.003777, 64.99, 0.1919])
        #p0 = np.array([0.000732, 0.942, 0.000564, 0.838, 0.000564, 0.838, 0.0, 0.003777, 64.99, 0.1919])
        #p0 = np.array([0.000732, 0.942, 0.000564, 0.838, 0.000564, 0.838, -27.1, 0.090384, 64.99, 0.1919])
        ###p0 = np.array([0.000732, 0.942, 0.000564, 0.838, 0.000564, 0.838, -2.479, -0.010384, 64.99, 0.1919])
